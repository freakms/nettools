...
def handle_locked_dirs():
    ...
    if os.path.exists("dist"):
        ...
        try:
            ...
            print("2. Open Task Manager and end NetToolsSuite.exe")
            print("3. Close File Explorer windows showing dist folder")
            print("4. Try again")
            return False
...
def build_executable():
    ...
    try:
        ...
        print("="*60)
        print("\nExecutable: dist/NetToolsSuite/NetToolsSuite.exe")
        print("Distribute the entire dist/NetToolsSuite folder\n")
    except Exception as e:
        print("\n" + "="*60)
